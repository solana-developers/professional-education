...
- The files in `labs` are working solutions to each lesson's labs
- The Instructor presentation is in this folder. We use Keynote as there are animations used in some slides.  

If you're planning on running a training event, welcome, you're in the right place! You can also contact mike.maccana@solana.org for help.
...
Solana Foundation NY office has most things
		*Ryan: I've got the chairs and tables covered for your event. I've got 6 30x72" tables and ~40 chairs that I just ordered since both the incubator, the ecosystem teams will need them in an ongoing capacity.* 
